...
public class TypeCastException extends IllegalArgumentException {
    ...
    public TypeCastException( RootType<?> rootType, Object fromValue, Throwable cause ) {
        this( String.format( "Cannot coalesce from getValue %s of class %s to %s", fromValue, fromValue != null ? fromValue.getClass() : null, rootType ), rootType, fromValue != null ? fromValue.getClass() : null, cause );
    }

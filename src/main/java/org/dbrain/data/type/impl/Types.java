...
import org.dbrain.data.type.decimal.DecimalType;
...
public class Types {
     ...
     * <code>"bob" == "bob"</code>
     */
    public static StringType STRING = new StringType( 0,
                                                      true,
                                                      StringType.TrimHandling.NONE,
                                                      StringType.CaseHandling.NONE,
                                                      StringType.BlankHandling.NONE );

    /**
     * Standard field string == Case insensitive trimmed string.
     */
    public static StringType FSTRING = new StringType( 0,
                                                       false,
                                                       StringType.TrimHandling.BOTH,
                                                       StringType.CaseHandling.NONE,
                                                       StringType.BlankHandling.BLANK_IS_NULL );
     ...
     * <code>"bob  " == "BOB"</code>
     */
    public static StringType DBSTRING = new StringType( 0,
                                                        false,
                                                        StringType.TrimHandling.TRAILING,
                                                        StringType.CaseHandling.NONE,
                                                        StringType.BlankHandling.NONE );

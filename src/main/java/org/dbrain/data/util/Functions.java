...
public class Functions {
    ...
    public static <T> Function<T, T> composeAlike( final Function<T, T> function1,
                                                   final Function<T, T> function2,
                                                   final Function<T, T> function3 ) {
